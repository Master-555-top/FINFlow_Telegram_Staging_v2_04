...
export const FINFLOW_DATA_KEYS: FinflowDataKey[] = [
  ...
  { key: 'finflow.historicalMoneyLedger.v2_53', label: 'История: деньги', section: 'money', periodField: 'records.localDate', exactPeriodReset: true },
  { key: 'finflow.historicalWorkLedger.v2_53', label: 'История: работа', section: 'work', periodField: 'records.localDate', exactPeriodReset: true },
  { key: 'finflow.historicalFundsLedger.v2_53', label: 'История: фонды', section: 'funds', periodField: 'records.localDate', exactPeriodReset: true },
