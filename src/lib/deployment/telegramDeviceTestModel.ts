export const TELEGRAM_DEVICE_TEST_VERSION = 'telegram_device_test_v2_04' as const;
...
export function buildTelegramDeviceTestRunbook(): TelegramDeviceTestRunbook {
  return {
    ...
    nextStepAfterDeviceTest: 'v2.05 — Telegram UX Touch Polish / Safe Cloud Save Pilot после реального device-test отчёта'
  };
}
